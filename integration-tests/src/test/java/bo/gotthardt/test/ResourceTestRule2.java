...
public class ResourceTestRule2 implements TestRule {
    ...
    public static class Builder {
        ...
        public ResourceTestRule2 build() {
            return new ResourceTestRule2(singletons, providers, properties, mapper, validator);
        }
    }
    ...
    private ResourceTestRule2(Set<Object> singletons,
                             Set<Class<?>> providers,
